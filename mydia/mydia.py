...
class Videos(object):
    ...
    target_size : tuple, optional
        ...
        .. note:: A single video is a stack of frames. If the dimension of all the frames is not the same, they cannot by stacked.
    ...
    num_frames : int, optional
        ...
        .. note:: Videos are stacked together. If the number of frames in all the videos are not the same, they cannot be stacked.
